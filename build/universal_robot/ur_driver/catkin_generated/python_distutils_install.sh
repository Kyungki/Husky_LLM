...
echo_and_run cd "/home/kyungki/workspace/husky_ws/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/kyungki/workspace/husky_ws/src/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/kyungki/workspace/husky_ws/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
