...
(cl:in-package chatgpt_connector-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ChatGpt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChatGpt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chatgpt_connector-srv:<ChatGpt-request> is deprecated: use chatgpt_connector-srv:ChatGpt-request instead.")))

(cl:ensure-generic-function 'prompt-val :lambda-list '(m))
(cl:defmethod prompt-val ((m <ChatGpt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatgpt_connector-srv:prompt-val is deprecated.  Use chatgpt_connector-srv:prompt instead.")
  (prompt m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ChatGpt-request>)))
  ...
  "chatgpt_connector/ChatGptRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ChatGpt-request)))
  "Returns string type for a service object of type 'ChatGpt-request"
  "chatgpt_connector/ChatGptRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ChatGpt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChatGpt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chatgpt_connector-srv:<ChatGpt-response> is deprecated: use chatgpt_connector-srv:ChatGpt-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <ChatGpt-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatgpt_connector-srv:response-val is deprecated.  Use chatgpt_connector-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ChatGpt-response>)))
  ...
  "chatgpt_connector/ChatGptResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ChatGpt-response)))
  "Returns string type for a service object of type 'ChatGpt-response"
  "chatgpt_connector/ChatGptResponse")
